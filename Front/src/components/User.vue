<template>
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h2 style="text-align: center" class="mt-5 mb-3">
        ...
        >
          <form
            @submit.prevent="UpdateUser(users.id)"
            method="post"
            style="margin: 10px"
          >
            <div class="row mt-4">
            ...
            <div class="row mt-4">
              ...
              <div class="col-md-8">
                <input
                  ...
                  type="text"
                  name="name"
                  v-bind:placeholder="users.username"
                />
              </div>
            </div>
...
export default {
  name: "Users",
  mounted: function () {
    const userID = localStorage.getItem("userTime");
